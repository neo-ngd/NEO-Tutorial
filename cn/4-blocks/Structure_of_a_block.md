...
```
下面是上述请求返回结果的简短版本，去掉了请求的元数据，且只显示了区块内众多交易中的一个。然而，它已经提供了足够的信息来帮助我们理解区块的结构。cURL请求的完整响应可以点击[此处](neo-block.json)查看。
...
可以使用区块浏览器来以一种对用户更为友好的方式查看区块信息。Neoscan.io就是这样的一个浏览器，上面所说的那个区块可以点击[这个URL](https://neoscan.io/block/ad83d993ca2d9783ca86a000b39920c2508ccae7b7db11806646a4832bc50)来查看。区块包含的信息和交易如下所示。调用脚本和验证脚本信息没有在图中显示，且在[区块验证 & 处理](4-Block_validation_processing.md)一节有详细的讨论。
